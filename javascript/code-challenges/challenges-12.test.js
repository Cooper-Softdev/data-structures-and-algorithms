...
const validateWord = (word) => {
  // Solution code here...
  const lengthReqs = /^\D{5,10}$/
  return lengthReqs.test(word);
};
...
const validateEmail = (email) => {
  // Solution code here...
  const emailValid = /^[a-zA-Z0-9]+(\.[a-zA-Z0-9]+)?@[a-zA-Z0-9]+\.(com|net|org)$/
...
// My superior code which is superior and better and much more betterer.
