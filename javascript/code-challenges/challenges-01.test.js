...
const fizzbuzz = (arr) => {
  ...
  arr.forEach((num) => {
    if (num % 3 === 0 && num % 5 === 0) {
      fizzedBuzz.push('Fizz Buzz');
    } else if (num % 3 === 0) {
      fizzedBuzz.push('Fizz');
    } else if (num % 5 === 0) {
      fizzedBuzz.push('Buzz');
    } else {
      fizzedBuzz.push(num);
    }
  });
